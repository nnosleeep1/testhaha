...
public class Menu extends JPanel {
    ...
    private static final String menuItems[][] = {
        {"Bán thuốc"},
        {"Hóa đơn", "Tạo hóa đơn", "Quản lý đơn bán", "Đổi trả"},
        {"Thống kê", "Thống kê khách hàng", "Thống kê doanh thu", "Thống kê thuốc"},
        {"Khách hàng"},
        {"Nhân viên"},
        {"Nhà cung cấp"},
        {"Đăng xuất"}
...
//        String title = Application.employee == null ? " Chủ tịch Cảnh " : String.format(" %s. %s ", Application.employee.getRole(), Application.employee.getName());
        lbl_currentEmployee = createTitle("Tran Xuan Truong");
